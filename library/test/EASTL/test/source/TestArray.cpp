...
int TestArray()
{
	...
	{ 
		...
		// begin, end
		safe_memory::array<int, 5>::iterator it = a.begin();
		...
		// rbegin, rend
		safe_memory::array<int, 5>::reverse_iterator itr = a.rbegin();
	...
	// constexpr tests
	{
		...
		EA_CPP14_CONSTEXPR safe_memory::array<int, 4> a = {{ 0, 1, 2, 3 }};

		static_assert(a == safe_memory::array<int, 4>{{ 0, 1, 2, 3 }}, "array constexpr failure");

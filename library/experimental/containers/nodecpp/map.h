...
public:
    ...
    __map_value_compare()
        _NOEXCEPT_(std::is_nothrow_default_constructible<_Compare>::value)
        : _Compare() {}
    _LIBCPP_INLINE_VISIBILITY
    __map_value_compare(_Compare c)
        _NOEXCEPT_(std::is_nothrow_copy_constructible<_Compare>::value)
        : _Compare(c) {}
    _LIBCPP_INLINE_VISIBILITY
    ...
    void swap(__map_value_compare&__y)
        _NOEXCEPT_(std::is_nothrow_swappable<_Compare>::value)
    {
      using _VSTD::swap;
    ...
    _LIBCPP_INLINE_VISIBILITY
    typename std::enable_if<__is_transparent<_Compare, _K2>::value, bool>::type
...
struct __value_type
{
    ...
    typedef std::pair<key_type&, mapped_type&>            __nc_ref_pair_type;
    typedef std::pair<key_type&&, mapped_type&&>          __nc_rref_pair_type;
...
public:
    ...
    __value_type(_Types&&... _Args) : __cc(std::forward<_Types>(_Args)...) {}
...
private:
    ...
    typedef nodecpp::__value_type<key_type, mapped_type>             __value_type;
    typedef __map_value_compare<key_type, __value_type, key_compare> __vc;
    typedef typename __rebind_alloc_helper<std::allocator_traits<allocator_type>,
...
public:
    ...
    _LIBCPP_INLINE_VISIBILITY
    void swap(map& __m)
        _NOEXCEPT_(std::is_nothrow_swappable<__base>::value)
    ...
    template <typename _K2>
    _LIBCPP_INLINE_VISIBILITY
    typename std::enable_if<__is_transparent<_Compare, _K2>::value,iterator>::type
    find(const _K2& __k)                           {return __tree_.find(__k);}
    template <typename _K2>
    _LIBCPP_INLINE_VISIBILITY
    typename std::enable_if<__is_transparent<_Compare, _K2>::value,const_iterator>::type
    ...
    template <typename _K2>
    _LIBCPP_INLINE_VISIBILITY
    typename std::enable_if<__is_transparent<_Compare, _K2>::value,size_type>::type
    ...
    template <typename _K2>
    _LIBCPP_INLINE_VISIBILITY
    typename std::enable_if<__is_transparent<_Compare, _K2>::value,std::pair<iterator,iterator>>::type
    equal_range(const _K2& __k)       {return __tree_.__equal_range_multi(__k);}
    template <typename _K2>
    _LIBCPP_INLINE_VISIBILITY
    typename std::enable_if<__is_transparent<_Compare, _K2>::value,std::pair<const_iterator,const_iterator>>::type

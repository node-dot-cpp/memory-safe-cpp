...
#ifndef NODECPP_CHECKER_NODECPP_TEMPORARYEXPRCHECK_H
#define NODECPP_CHECKER_NODECPP_TEMPORARYEXPRCHECK_H
...
#endif // NODECPP_CHECKER_NODECPP_TEMPORARYEXPRCHECK_H

...
set CLANG_OPTS=-isystem ../../../library/src/iibmalloc/src -isystem ../../../library/src -isystem ../../../library/src/iibmalloc/src/foundation/include -isystem ../../../library/src/iibmalloc/src/foundation/3rdparty/fmt/include -std=c++17 -fexceptions -fnon-call-exceptions -DNDEBUG -O2
set LDD_OPTS=-flto -fuse-ld=lld
...
clang++ zombie_this.cpp -o zombie_this.exe %LIBRARY_FILES% %CLANG_OPTS% %LDD_OPTS%
nodecpp-instrument -o zombie_this.instrumented.cpp zombie_this.cpp -- %CLANG_OPTS%
clang++ zombie_this.instrumented.cpp -o zombie_this.instrumented.exe %LIBRARY_FILES% %CLANG_OPTS% %LDD_OPTS% 

clang++ zombie_reference.cpp -o zombie_reference.exe %LIBRARY_FILES% %CLANG_OPTS% %LDD_OPTS%
nodecpp-instrument -o zombie_reference.instrumented.cpp zombie_reference.cpp -- %CLANG_OPTS%
clang++ zombie_reference.instrumented.cpp -o zombie_reference.instrumented.exe %LIBRARY_FILES% %CLANG_OPTS% %LDD_OPTS% 

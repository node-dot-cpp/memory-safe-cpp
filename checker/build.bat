...
cmake -DLLVM_TARGETS_TO_BUILD="X86" -DCMAKE_BUILD_TYPE=Release -DLLVM_ENABLE_PROJECTS="clang" -DLLVM_EXTERNAL_SAFEMEMORY_SOURCE_DIR=%cd%\..\.. -Thost=x64 -G "Visual Studio 16 2019" -A "Win64" ..\..\3rdparty\llvm-project\llvm
